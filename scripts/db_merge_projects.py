...
def main():
    ...
    cursor.execute('SELECT * FROM stats WHERE project_id LIKE ?',
                   [old_project_filter])
    ...
    cursor.execute('DELETE FROM stats WHERE project_id LIKE ?',
                   [old_project_filter])
    print 'Deleted rows from stats:', cursor.rowcount

    # Delete the project
    cursor.execute('DELETE FROM projects WHERE project_id LIKE ?', [
                   old_project_filter])
    ...
    print 'Inserted rows (stats):', added_rows
    ...
    print 'Inserted rows (projects):', cursor.rowcount
